...
{
    private final Map<SchemaTableName, RestTableDescription> map;

    public MapBasedTableDescriptionSupplier(Map<SchemaTableName, RestTableDescription> map)
    {
    ...
    @Override
    public Optional<RestTableDescription> getTableDescription(SchemaTableName schemaTableName)
    {
